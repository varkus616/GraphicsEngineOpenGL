...
{
	// Front face
	{{0.f, 0.f}, {-0.5f, -0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 0
	{{1.f, 0.f}, { 0.5f, -0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 1
	{{1.f, 1.f}, { 0.5f,  0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 2
	{{1.f, 1.f}, { 0.5f,  0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 2
	{{0.f, 1.f}, {-0.5f,  0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 3
	{{0.f, 0.f}, {-0.5f, -0.5f, -0.5f}, {0.0f,  0.0f, -1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 0

	// Back face
	{{1.f, 0.f}, {-0.5f, -0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 4
	{{0.f, 0.f}, { 0.5f, -0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 5
	{{0.f, 1.f}, { 0.5f,  0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 6
	{{0.f, 1.f}, { 0.5f,  0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 6
	{{1.f, 1.f}, {-0.5f,  0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 7
	{{1.f, 0.f}, {-0.5f, -0.5f,  0.5f}, {0.0f,  0.0f,  1.0f}, {1.f, 1.f, 1.f, 0.f}}, // 4

	// Left face
	{{0.f, 0.f}, {-0.5f,  0.5f,  0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 8
	{{1.f, 0.f}, {-0.5f,  0.5f, -0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 9
	{{1.f, 1.f}, {-0.5f, -0.5f, -0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 10
	{{1.f, 1.f}, {-0.5f, -0.5f, -0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 10
	{{0.f, 1.f}, {-0.5f, -0.5f,  0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 11
	{{0.f, 0.f}, {-0.5f,  0.5f,  0.5f}, {-1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 8

	// Right face
	{{1.f, 0.f}, { 0.5f,  0.5f,  0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 12
	{{0.f, 0.f}, { 0.5f,  0.5f, -0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 13
	{{0.f, 1.f}, { 0.5f, -0.5f, -0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 14
	{{0.f, 1.f}, { 0.5f, -0.5f, -0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 14
	{{1.f, 1.f}, { 0.5f, -0.5f,  0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 15
	{{1.f, 0.f}, { 0.5f,  0.5f,  0.5f}, {1.0f,  0.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 12

	// Top face
	{{0.f, 1.f}, {-0.5f, -0.5f, -0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 16
	{{1.f, 1.f}, { 0.5f, -0.5f, -0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 17
	{{1.f, 0.f}, { 0.5f, -0.5f,  0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 18
	{{1.f, 0.f}, { 0.5f, -0.5f,  0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 18
	{{0.f, 0.f}, {-0.5f, -0.5f,  0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 19
	{{0.f, 1.f}, {-0.5f, -0.5f, -0.5f}, {0.0f, -1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 16

	{{0.f, 0.f}, {-0.5f,  0.5f, -0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 20
	{{1.f, 0.f}, { 0.5f,  0.5f, -0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 21
	{{1.f, 1.f}, { 0.5f,  0.5f,  0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 22
	{{1.f, 1.f}, { 0.5f,  0.5f,  0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 22
	{{0.f, 1.f}, {-0.5f,  0.5f,  0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 23
	{{0.f, 0.f}, {-0.5f,  0.5f, -0.5f}, {0.0f,  1.0f,  0.0f}, {1.f, 1.f, 1.f, 0.f}}, // 20
};
